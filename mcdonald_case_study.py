# -*- coding: utf-8 -*-
"""McDonald_Case_Study.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1v4fyHnIdaBvYKuIoztczoGhS9dzBME3a
"""
...
#Loading the dataset
df = pd.read_csv("/content/drive/MyDrive/Machine-learning-dataset/mcdonalds.csv")
df.shape
df.head()
df.dtypes
...
df.hist(color='brown')  # Change the color to 'purple'
plt.show()
